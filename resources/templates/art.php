...
<div class="content">
	<p class="mb-4">Wer Street-Art mag, ist hier richtig. Der Spaziergang
		beginnt in Temple Bar, wo es an einer Hauswand ein grosses Portrait
		des K&uuml;nstlers BP Fallon zu sehen gibt. Weiter geht es zu einem
		Street-Art- Kunstwerk mit dem Namen the City is my garden und einer
		kleinen Freiluftausstellung aus drei Wandbildern. Auf dem weiteren Weg
		gibt es ein Trash Animal zu entdecken, ein Werk namens Dead Meat und
		bunte T&uuml;ren. Weiter geht es zum Bild Subset Football und
		schliesslich zu einem abstrakten Kunstwerk.</p>
</div>
<div class="show-more">
...
<hr class="my-4 large">
<h3 id="bp-fallon">
	<a class="custom-url" href="quellen.php#24">BP Fallon<sub>24</sub></a>
</h3>
...
<h3 id="the-city-is-my-garden">
	<a class="custom-url" href="quellen.php#25">The city is my garden<sub>25</sub></a>
</h3>
...
<p>Abbildung(en): The city is my garden</p>
<hr class="my-4">
<div class="content">
...
<h3 id="drei-verschiedene-streetarts">
	<a class="custom-url" href="quellen.php#26">Drei verschiedene
		Street-Arts<sub>26</sub>
	</a>
</h3>
...
<p>Abbildung(en): Drei verschiedene Street-Arts</p>
<hr class="my-4">
<div class="content">
...
<hr class="my-4 large">
<h3 id="trash-animals">
	<a class="custom-url" href="quellen.php#27">Trash Animals<sub>27</sub></a>
</h3>
...
<p>Abbildung(en): Trash Animals</p>
<hr class="my-4">
<div class="content">
...
<hr class="my-4 large">
<h3 id="dead-meat">
	<a class="custom-url" href="quellen.php#28">Dead Meat<sub>28</sub></a>
</h3>
...
<h3 id="gregorianische-tueren">
	<a class="custom-url" href="quellen.php#29">Georgianische T&uuml;ren<sub>29</sub></a>
</h3>
...
<p>Abbildung(en): Georgianische T&uuml;ren</p>
<hr class="my-4">
<div class="content">
...
<h3 id="subset-football">
	<a class="custom-url" href="quellen.php#30">Subset Football<sub>30</sub></a>
</h3>
...
<p>Abbildung(en): Subset Football</p>
<hr class="my-4">
<div class="content">
...
<h3 id="vadis-und-tilf">
	<a class="custom-url" href="quellen.php#31">Vadis und Tilf<sub>31</sub></a>
</h3>
...
<p>Abbildung(en): Vadis und Tilf</p>
<hr class="my-4">
<div class="content">
